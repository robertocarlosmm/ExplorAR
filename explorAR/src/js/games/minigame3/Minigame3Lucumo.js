...
export class Minigame3Lucumo {
    ...
    async start() {
        console.log("[Minigame3Lucumo] Iniciando RA...");
        ...
        console.log("[Minigame3Lucumo] Cubo generado, RA activo.");
    }

    _onTimeUp() {
        console.log("[Minigame3Lucumo] Tiempo finalizado");
        this.hud?.showPopup?.({
    ...
    dispose() {
        ...
        this.hud?.stopTimer?.();
        console.log("[Minigame3Lucumo] Recursos liberados");
    }
}